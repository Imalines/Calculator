...
class Testing {
	...
	int[] inputTest1 = {KeyEvent.VK_1,KeyEvent.VK_R,KeyEvent.VK_COMMA,KeyEvent.VK_5};
	int[] inputTest2 = {KeyEvent.VK_COMMA,KeyEvent.VK_0,KeyEvent.VK_COMMA,KeyEvent.VK_5};
